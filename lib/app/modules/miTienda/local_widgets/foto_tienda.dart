            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Obx(() => 
                    ( controller.cargandoFoto )
                    ? Image( image: AssetImage( 'assets/giphy.gif' ), fit: BoxFit.cover,)
                    : Image(
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.only( bottomRight: Radius.circular(_responsive.wp(4)), bottomLeft: Radius.circular(_responsive.wp(4))),
                  ),
                ),
              ),
              Positioned(
            ...
            children: [              
              Container(
                ...
                child: MaterialButton(
                  child: Padding(
                    ...
                    child: Icon(Icons.gps_fixed, size: _responsive.wp(10), color: Colors.white),
                  ),
              ...
              Container(
                ...
                child: MaterialButton(
                  child: Padding(
                    padding: EdgeInsets.all(_responsive.wp(2)),
                    child: Icon(Icons.access_time, size: _responsive.wp(10), color: Colors.white),
                  ),
                  shape: CircleBorder(),
                  color: miTema().primaryColor,
                  onPressed: (){}

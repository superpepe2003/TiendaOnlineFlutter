            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Obx(() => 
                    ( controller.cargandoFoto && (controller.index == index || controller.index == -1) )
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.only( bottomRight: Radius.circular(_resp.wp(4)), bottomLeft: Radius.circular(_resp.wp(4))),
                  ),
                ),
              ),
              Positioned(
                ...
                child: Container(
                  ...
                  child: IconButton(
                    icon: Icon(Icons.add),
                    iconSize: _resp.wp(8),
                    onPressed: (controller.cargandoFoto) ? null :() async {

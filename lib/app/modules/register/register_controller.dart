    ...
    return () async {
      ...
      try {        
        ...
        if ( result.email != null ) {
          Get.snackbar('Usuario', 'Usuario Creado', snackPosition: SnackPosition.BOTTOM );
          limpiarCampos();
        }
      } catch (e) {
        Get.snackbar('Error', 'El mail existe o hay datos incorrectos', snackPosition: SnackPosition.BOTTOM);
      }

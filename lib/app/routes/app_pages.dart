...
class AppPages {
  ...
  static final List<GetPage> pages = [
    ...
    GetPage(name: AppRoutes.PERFIL , page: () => PerfilPage(), binding: PerfilBinding() ),
    GetPage(name: AppRoutes.TIENDAS , page: () => TiendasPage(), binding: TiendasBinding() ),
    GetPage(name: AppRoutes.TIENDA , page: () => TiendaPage(), binding: TiendaBinding() ),
    GetPage(name: AppRoutes.PRODUCTO , page: () => ProductoPage(), binding: ProductoBinding() ),
    GetPage(name: AppRoutes.MITIENDA , page: () => MitiendaPage(), binding: MiTiendaBinding() ),
    GetPage(name: AppRoutes.MIPRODUCTOS , page: () => MiProductoPage(), binding: MiProductosBinding() ),
